...
[Console]::Error.WriteLine('DEPRECATION: scripts/arena.ps1 forwards to the Python controller; invoke the selected Python interpreter with scripts/arena.py directly.')
...
$entrypoint = Join-Path $PSScriptRoot 'arena.py'
