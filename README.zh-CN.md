...
- **三套真实方向。** 三个候选都从最终 `BASE_SHA` 出发，分支分别为 `style-a`、`style-b`、`style-c`；只改配色、字体、圆角或明暗模式不算三个方向。
...
| 日期（UTC+8） | 提交 | 变化 |
| --- | --- | --- |
| 2026-07-12 | `a996ba9` | 建立三 worktree、用户选择完整赢家的初始 Skill。 |
| 2026-07-14 | `be6ee06` | 加入由参考资料驱动的设计质量门槛。 |
| 2026-07-14 | `8f1d29b` | 加入首版设计质量参考库。 |
| 2026-07-14 | `fc73b74` | 隔离领域 brief，使 builder 只接收其被分配的方向。 |
| 2026-07-14 | `86c4ea3` | 强化冻结参考、brief、合并验证与分支保留规则。 |
| 2026-07-14 | `f3134b1` | 明确运行记录和已批准 brief 的合同。 |
| 2026-07-15 | `0a553bf` | 加入脚本化生命周期状态机、完整性工具、schema 与 smoke 覆盖。 |
| 2026-07-15 | `fbd17af` | 加入声明式浏览器 QA 和五门资格审查流程。 |
| 2026-07-15 | `d9125f6` | 聚焦主工作流，并将操作细节拆入独立参考文档。 |
